...
class RentalPropertyForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
			...
			"squares": forms.NumberInput(attrs={"class": "form-control", "min": 0}),
			"total_beds": forms.NumberInput(attrs={"class": "form-control", "min": 0}),
			"total_toilets": forms.NumberInput(attrs={"class": "form-control", "min": 0}),
...
class PropertyForm(forms.ModelForm):
	class Meta:
		model = Property
		fields = ["name", "address", "description", "property_type", "attorney", "purchase_date", "previous_sold_value", "latitude", "longitude"]
		widgets = {
			"name": forms.TextInput(attrs={"class": "form-control"}),
			"address": forms.TextInput(attrs={"class": "form-control"}),
			...
			"previous_sold_value": forms.NumberInput(attrs={"class": "form-control"}),
